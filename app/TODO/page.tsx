                  ...
                  <li key={t.id} className="p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        {t.note && <div className="text-sm opacity-70">{t.note}</div>}
                      </div>
                      <div className="flex items-center gap-2">
                        {t.pinned && <span className="badge badge-primary badge-outline">Pinned</span>}
                        <span className="badge badge-outline">P{t.priority}</span>
                        {t.due_date && <span className="badge badge-ghost">Due {t.due_date}</span>}
                      </div>
                    </div>
                  </li>
                ))}
